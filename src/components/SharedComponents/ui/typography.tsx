...
const H1: React.FC<Props> = ({className, children}) => {
    return (
      <h1 className={`font-heading scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl ${className}`}>
        {children}
      </h1>
    )
  }
  ...
  const H2: React.FC<Props> = ({className, children}) => {
    return (
      <h2 className={`font-heading scroll-m-20 border-b pb-2 text-3xl font-semibold tracking-tight first:mt-0 ${className}`}>
        {children}
      </h2>
    )
  }
  ...
  const H3: React.FC<Props> = ({className, children}) => {
    return (
      <h3 className={`font-heading scroll-m-20 text-2xl font-semibold tracking-tight ${className}`}>
        {children}
      </h3>
    )
  }
